...
const Navbar = ({ isLoggedIn, setIsLoggedIn, userId }) => {
  ...
  const navbarColor =
    location.pathname === "/"
      ...
      : "bg-white shadow-md";
  const svgColor =
    scrolling || location.pathname !== "/" ? "#333333" : "#FFFFFF";
  const textColor =
    scrolling || location.pathname !== "/" ? "text-[#333333]" : "text-white";
    ...
    <>
      ...
      >
        <div className="max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex justify-between items-center">
          ...
          <Link
            to="#"
            className="menu-bars transition-colors duration-300"
            onClick={showSidebar}
          >
            <svg
          ...
          <div className="logo">
            <Link
              to="/"
              className={`font-garamond font-semibold text-xl md:text-3xl tracking-[10px] md:tracking-[18px] ${textColor}`}
            >
              SIXSTREET
            </Link>
          </div>
            ...
            <div ref={dropdownRef} className="hidden md:block md:relative">
              ...
              >
                ...
                >
                  ...
                  />
                  <path
                    d="M34.3167 36.6667C34.3167 30.2167 27.9 25 20 25C12.1 25 5.68335 30.2167 5.68335 36.6667"
                    strokeWidth="2"
                    strokeLinecap="round"
                  />
                </svg>
                  ...
                  <div className="py-1">
                    {isLoggedIn ? (
                      <>
                        <Link
                          to={`/profile/${userId}`}
                          className="block px-4 py-2 text-[#333333] font-medium font-overpass text-center"
                        >
                          Profile
                        </Link>
                        <Link
                        ...
                        <button
                          ...
                          className="block w-full px-4 py-2 text-[#333333] font-medium font-overpass text-center"
                        >
                          Logout
                        </button>
                      </>
