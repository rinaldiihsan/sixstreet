...
const Sidebar = ({ sidebarOpen, showSidebar, isLoggedIn, setIsLoggedIn, userId }) => {
  ...
  const handleSearch = (e) => {
    ...
    const allItems = [...SixStreet, ...featuredBrand, ...Tops, ...Bottom, ...Footwear, ...Accessories, ...Sale];

    const results = allItems.filter((item) => item.name.toLowerCase().includes(term));
            ...
            <div className="flex-1 flex flex-col py-10 overflow-y-auto">
              ...
              <div className="mt-5 px-8 space-y-1">
                <div className="relative">
                  <input type="text" placeholder="Search" value={searchTerm} onChange={handleSearch} className="block w-full pl-4 pr-10 py-3 border border-gray-300 focus:ring-gray-300 focus:border-gray-300 sm:text-[1rem] font-overpass" />
