  ...
  const fetchProducts = async () => {
    try {
      ...
      if (response.data.success) {
        const rajawaliProducts = getRajawaliProduct(response.data.data);
        setProducts(rajawaliProducts);
      } else {
