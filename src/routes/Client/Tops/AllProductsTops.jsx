...
import AssetBannerTops from '../../../assets/banner/all-tops.webp';

const AllProductsTops = () => {
  ...
  const fetchProducts = async (token) => {
    try {
      ...
      if (response.status === 200) {
        ...
        const sixstreetProducts = data.filter((item) => [18215, 18218, 18210, 18216, 18199, 18198, 18209, 18217, 18200].includes(item.item_category_id));
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img src={AssetBannerTops} alt="Hero Hoodies" className="w-full h-full md:h-auto mb-6" />
        {/* Filter  */}
        ...
        <div className="w-full flex justify-between md:gap-x-3 overflow-x-hidden">
          ...
          <div className="w-full grid grid-cols-2 gap-5 lg:grid-cols-3 mb-10 overflow-y-auto h-[calc(100vh-4rem)] md:px-5 overflow-x-hidden scroll-hidden">
            ...
            ) : loginStatus === 'success' && products.some((item) => [18215, 18218, 18210, 18216, 18199, 18198, 18209, 18217, 18200].includes(item.item_category_id)) ? (
              <>
                {/* Produk yang tersedia */}
                {Object.values(
                  products
                    .filter((item) => [18215, 18218, 18210, 18216, 18199, 18198, 18209, 18217, 18200].includes(item.item_category_id))
                    .flatMap((item) => ({
                      ...item.variants[0],
...
export default AllProductsTops;
