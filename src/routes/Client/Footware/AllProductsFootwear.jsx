...
import assetBannerFootwear from "../../../assets/banner/Sneakers.webp";
              ...
              <p className="font-overpass capitalize">
                {
                  products
                    .filter((item) =>
                      [
                        5472, 999, 1013, 12780, 12803, 12595, 12808, 1009, 1033,
                        7560, 12794, 7545, 17895, 1013, 24806, 24807,
        ...
        <div className="w-full flex justify-between md:gap-x-3 overflow-x-hidden">
          ...
          <div className="w-full grid grid-cols-2 gap-5 lg:grid-cols-3 mb-10 overflow-y-auto h-[calc(100vh-4rem)] md:px-5 overflow-x-hidden">
            {isLoading ? (
              ...
              products.some((item) =>
                [
                  5472, 999, 1013, 12780, 12803, 12595, 12808, 1009, 1033, 7560,
                  12794, 7545, 17895, 1013, 24806, 24807,
                ].includes(item.item_category_id)
              ) ? (
              <>
