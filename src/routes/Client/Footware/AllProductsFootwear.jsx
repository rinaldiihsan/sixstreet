...
import AssetBannerFootwear from '../../../assets/banner/all-footwear.webp';

const AllProductsFootwear = () => {
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img src={AssetBannerFootwear} alt="Hero Hoodies" className="w-full h-full md:h-auto mb-6" />
        {/* Filter  */}
          ...
          <div className="flex flex-grow">
            ...
            <div className="border-t border-b border-r lg:border-r-0 border-[#E5E5E5] flex-grow flex items-center px-4 md:px-10 py-5">
              <p className="font-overpass capitalize">
                {products.filter((item) => [5472, 999, 1013, 12780, 12803, 12595, 12808, 1009, 1033, 7560, 12794, 7545, 17895, 1013, 24806, 24807].includes(item.item_category_id)).flatMap((item) => item.variants).length} Result
              </p>
            </div>
        ...
        <div className="w-full flex justify-between md:gap-x-3 overflow-x-hidden">
          ...
          <div className="w-full grid grid-cols-2 gap-5 lg:grid-cols-3 mb-10 overflow-y-auto h-[calc(100vh-4rem)] md:px-5 overflow-x-hidden scroll-hidden">
            ...
            ) : loginStatus === 'success' && products.some((item) => [5472, 999, 1013, 12780, 12803, 12595, 12808, 1009, 1033, 7560, 12794, 7545, 17895, 1013, 24806, 24807].includes(item.item_category_id)) ? (
              <>
                {/* Produk yang tersedia */}
                {Object.values(
                  products
                    .filter((item) => [5472, 999, 1013, 12780, 12803, 12595, 12808, 1009, 1033, 7560, 12794, 7545, 17895, 1013, 24806, 24807].includes(item.item_category_id))
                    .flatMap((item) => ({
                      ...item.variants[0],
