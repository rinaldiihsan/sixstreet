        ...
        <div className="bg-white p-8 shadow-md mx-3 md:max-w-[50rem] w-full space-y-10">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex flex-col md:flex-row justify-between">
              ...
              <p className="font-overpass max-w-md md:text-end">{transactionData[0].address}</p>
            </div>
            <div className="flex flex-col md:flex-row justify-between">
          ...
          <button onClick={handlePayment} className="bg-[#333333] text-white py-2 px-4 mt-4 rounded font-overpass capitalize">
            Pay for this item
          </button>
        </div>
      ) : (
