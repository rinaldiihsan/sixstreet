...
const Checkout = () => {
  ...
  const handlePayment = async () => {
    ...
    const selectedSubdistrictData = subdistricts.find(
      (sub) => sub.subdistrict_id === selectedSubdistrict
    );
    ...
    try {
      ...
      const updateData = {
        ...
        city: selectedCityData
          ? `${selectedCityData.type} ${selectedCityData.city_name}`
          : "",
        sub_district: selectedSubdistrictData
          ? selectedSubdistrictData.subdistrict_name
          : "",
            ...
            {selectedSubdistrict && (
              <div className="flex flex-col md:flex-row justify-between">
                ...
                <textarea
                  ...
                  className="font-overpass md:text-end p-2 border rounded w-full md:w-1/2"
                  rows="3"
                />
              </div>
            )}
              ...
              <div className="border p-4 rounded-lg space-y-4">
                ...
                <div className="flex flex-col md:flex-row justify-between">
                  ...
                  <select
                    ...
                    className="font-overpass md:text-end p-2 border rounded w-full md:w-auto"
                  >
                    ...
                    {shippingCosts.map((service) => {
                      ...
                      return (
                        <option key={service.service} value={service.service}>
                          {service.service} -{" "}
                          {formatCurrency(service.cost[0].value)} - {etdText}{" "}
                          hari
                        </option>
                      );
                    })}
                      ...
                      .map((service) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <p className="text-gray-600">
                              Estimasi pengiriman: {etdText} hari
                            </p>
                          </div>
                        );
                      })}
