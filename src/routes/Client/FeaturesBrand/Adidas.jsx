...
const Adidas = () => {
  ...
  const getAdidasProducts = (products) => {
  ...
  const fetchProducts = async () => {
    try {
      ...
      if (response.data.success) {
        const adidasProducts = getAdidasProducts(response.data.data);
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center">
        ...
        <img src={HeroAdidas} alt="Hero Adidas" className="w-full h-full md:h-auto mb-6" />
