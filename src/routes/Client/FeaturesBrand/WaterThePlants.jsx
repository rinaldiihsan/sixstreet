  ...
  const fetchProducts = async () => {
    try {
      ...
      if (response.data.success) {
        const wtpProducts = getWtpProducts(response.data.data);
        setProducts(wtpProducts);
      } else {
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center">
        ...
        <img src={assetWtp} alt="Hero Adidas" className="w-full h-full md:h-auto mb-6" />
