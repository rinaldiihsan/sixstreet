  ...
  const fetchProducts = async () => {
    try {
      ...
      if (response.data.success) {
        const oncloudProducts = getOnProducts(response.data.data);
        setProducts(oncloudProducts);
      } else {
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center">
        ...
        <img src={heroOn} alt="Hero Adidas" className="w-full h-full md:h-auto mb-6" />
