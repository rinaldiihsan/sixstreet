  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroOn} // Pastikan untuk mengganti dengan gambar hero ON CLOUD
          alt="Hero ON CLOUD"
              ...
              <p className="font-overpass capitalize">
                {
                  products
                    ...
                    .filter((variant) =>
                      variant.item_name.toUpperCase().includes("ON CLOUD")
                    ).length
                }{" "}
                Result
              </p>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesOnCloud = variant.item_name
                      .toUpperCase()
                      .includes("ON CLOUD");
                    ...
                    return matchesOnCloud && matchesCategory;
                  })
                  .filter(
                    (variant) =>
