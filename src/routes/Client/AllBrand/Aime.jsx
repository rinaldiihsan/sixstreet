...
import heroAime from '../../../assets/banner/AIME-LEON-DORE.webp';
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroAime} // Pastikan untuk mengganti dengan gambar hero AIME
          alt="Hero AIME"
          className="w-full h-full md:h-auto mb-6"
        />
        <h1 className="text-center text-xs font-overpass lg:max-w-7xl  md:block md:text-base">
          Aime Leon Dore is a New York City-based streetwear brand known for its vintage-inspired aesthetic and high-quality craftsmanship. Founded by Teddy Santis, the brand offers a range of menswear and womenswear collections, including
          sweaters, t-shirts, outerwear, and accessories. Aime Leon Dore is often praised for its attention to detail, use of premium materials, and collaborations with other brands and artists.
        </h1>
        ...
        <div className="w-full flex justify-between mb-6 sticky top-[70px] bg-white z-[997] py-1 md:py-4">
          <div className="flex flex-grow">
            ...
            <div className="border-t border-b border-r lg:border-r-0 border-[#E5E5E5] flex-grow flex items-center px-4 md:px-10 py-5">
              <p className="font-overpass capitalize">{products.flatMap((item) => item.variants).filter((variant) => variant.item_name.toUpperCase().includes('AIME')).length} Hasil</p>
            </div>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => variant.item_name.toUpperCase().includes('AIME'))
