    ...
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <h1 className="text-center text-xs font-overpass lg:max-w-7xl  md:block md:text-base">
          Awake NY is a streetwear brand founded by Angelo Baque in New York City. Known for its minimalist aesthetic and bold graphics, Awake NY offers a range of apparel and accessories. The brand is inspired by Baque's experiences
          growing up in New York and his passion for skateboarding.
        </h1>
        {/* Filter  */}
        <div className="w-full flex justify-between mb-6 sticky top-[70px] bg-white z-[997] py-1 md:py-4">
          <div className="flex flex-grow">
            ...
            <div className="border-t border-b border-r lg:border-r-0 border-[#E5E5E5] flex-grow flex items-center px-4 md:px-10 py-5">
              <p className="font-overpass capitalize">{products.flatMap((item) => item.variants).filter((variant) => variant.item_name.toUpperCase().includes('AWAKE NY')).length} Hasil</p>
            </div>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => variant.item_name.toUpperCase().includes('AWAKE NY'))
