...
import heroMnml from "../../../assets/banner/06-MNML.webp";
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroMnml} // Pastikan untuk mengganti dengan gambar hero MNML
          alt="Hero MNML"
              ...
              <p className="font-overpass capitalize">
                {
                  products
                    ...
                    .filter((variant) =>
                      variant.item_name.toUpperCase().includes("MNML")
                    ).length
                }{" "}
                Result
              </p>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesMnml = variant.item_name
                      .toUpperCase()
                      .includes("MNML");
                    ...
                    return matchesMnml && matchesCategory;
                  })
                  .filter(
                    (variant) =>
