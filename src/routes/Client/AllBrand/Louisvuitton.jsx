...
import heroLouisVuitton from "../../../assets/banner/LOUIS-VUITTON.webp";
      ...
      if (response.status === 200) {
        ...
        const sixstreetProducts = data.filter((item) =>
          item?.variants?.some((variant) => {
            ...
            return name.includes("louis vuiton");
          })
        );
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroLouisVuitton} // Pastikan untuk mengganti dengan gambar hero LOUIS VOUITON
              ...
              <p className="font-overpass capitalize">
                {
                  products
                    ...
                    .filter((variant) =>
                      variant.item_name.toUpperCase().includes("LOUIS VOUITON")
                    ).length
                }{" "}
                Result
              </p>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesLuisVuitton = variant.item_name
                      .toUpperCase()
                    ...
                    return matchesLuisVuitton && matchesCategory;
                  })
                  .filter(
                    (variant) =>
