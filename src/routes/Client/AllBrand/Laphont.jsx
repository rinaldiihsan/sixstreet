...
import heroLaphont from "../../../assets/banner/LAPHONT.webp";
      ...
      if (response.status === 200) {
        ...
        const sixstreetProducts = data.filter((item) =>
          item?.variants?.some((variant) => {
            ...
            return name.includes("laphont montreal");
          })
        );
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroLaphont} // Pastikan untuk mengganti dengan gambar hero LAPHONT MONTREAL
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesLaphont = variant.item_name
                      .toUpperCase()
                      .includes("LAPHONT MONTREAL");
                    ...
                    return matchesLaphont && matchesCategory;
                  })
                  .filter(
                    (variant) =>
