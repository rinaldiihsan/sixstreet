...
import heroBearbrick from '../../../assets/banner/bearbrick.webp';
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroBearbrick} // Pastikan untuk mengganti dengan gambar hero BEARBRICK
          alt="Hero BEARBRICK"
          className="w-full h-full md:h-auto mb-6"
        />
        <h1 className="text-center text-xs font-overpass lg:max-w-7xl  md:block md:text-base">
          Bearbrick is a collectible toy figure produced by the Japanese company Medicom Toy. The Bearbrick is a simple cube-shaped figure with a bear-like face. It comes in various sizes and is often released in limited editions and
          collaborations with popular brands, artists, and franchises. Bearbricks have become highly sought-after by collectors and have developed a significant following in the toy and streetwear culture.
        </h1>
        {/* Filter  */}
        <div className="w-full flex justify-between mb-6 sticky top-[70px] bg-white z-[997] py-1 md:py-4">
          <div className="flex flex-grow">
            ...
            <div className="border-t border-b border-r lg:border-r-0 border-[#E5E5E5] flex-grow flex items-center px-4 md:px-10 py-5">
              <p className="font-overpass capitalize">{products.flatMap((item) => item.variants).filter((variant) => variant.item_name.toUpperCase().includes('BEARBRICK')).length} Hasil</p>
            </div>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => variant.item_name.toUpperCase().includes('BEARBRICK'))
