...
import heroFredPerry from '../../../assets/banner/FRED-PERRY.webp';
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroFredPerry} // Pastikan untuk mengganti dengan gambar hero FRED PERRY
          alt="Hero FRED PERRY"
          className="w-full h-full md:h-auto mb-6"
        />
        <h1 className="text-center text-xs font-overpass lg:max-w-7xl  md:block md:text-base">
          Fred Perry is a British fashion brand founded by the legendary tennis player Fred Perry. Known for its iconic polo shirts, Fred Perry has become a cultural icon, associated with British subcultures and music scenes. The brand's
          polo shirts are characterized by their laurel wreath logo and high-quality cotton fabric. Fred Perry has expanded its product line to include other apparel, footwear, and accessories, while maintaining its heritage and connection
          to British style.
        </h1>
        {/* Filter  */}
        <div className="w-full flex justify-between mb-6 sticky top-[70px] bg-white z-[997] py-1 md:py-4">
          <div className="flex flex-grow">
            ...
            <div className="border-t border-b border-r lg:border-r-0 border-[#E5E5E5] flex-grow flex items-center px-4 md:px-10 py-5">
              <p className="font-overpass capitalize">{products.flatMap((item) => item.variants).filter((variant) => variant.item_name.toUpperCase().includes('FRED PERRY')).length} Hasil</p>
            </div>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => variant.item_name.toUpperCase().includes('FRED PERRY'))
