      ...
      if (response.status === 200) {
        ...
        const sixstreetProducts = data.filter((item) =>
          item?.variants?.some((variant) => {
            ...
            return name.includes('double school');
          })
        );
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesDoubleSchool = variant.item_name.toUpperCase().includes('DOUBLE SCHOOL');
                    ...
                    return matchesDoubleSchool && matchesCategory;
                  })
