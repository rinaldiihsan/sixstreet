...
import heroDoubleSchool from '../../../assets/banner/DOUBLE-SCHOOL.webp';
const DoubleSchool = () => {
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroDoubleSchool} // Pastikan untuk mengganti dengan gambar hero DOUBLE SCHOOL
          alt="Hero DOUBLE SCHOOL"
          className="w-full h-full md:h-auto mb-6"
        />
        <h1 className="text-center text-xs font-overpass lg:max-w-7xl  md:block md:text-base">
          DOUBLE SCHOOL is a tribute to 90’s culture, blending nostalgia with a modern twist. Inspired by 90’s fashion, music, and more, DOUBLE SCHOOL reimagines old-school vibes with a fresh, new-school edge. Offering top-quality products
          at reasonable prices, DOUBLE SCHOOL celebrates the individuality and creativity of the 90’s, connecting with today’s generation through its unique style.
        </h1>
        {/* Filter  */}
