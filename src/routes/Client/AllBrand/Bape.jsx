...
import heroBape from '../../../assets/banner/BAPE.webp';
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroBape} // Pastikan untuk mengganti dengan gambar hero BAPE
          alt="Hero BAPE"
          className="w-full h-full md:h-auto mb-6"
        />
        <h1 className="text-center text-xs font-overpass lg:max-w-7xl  md:block md:text-base">
          Bape, also known as A Bathing Ape, is a Japanese streetwear brand founded by Tomoaki Chitose. Known for its playful and iconic designs, Bape has become a global streetwear phenomenon. The brand is characterized by its bold
          graphics, camouflage patterns, and the Baby Milo character. Bape offers a wide range of products, including apparel, accessories, and footwear, often featuring limited-edition releases and collaborations with other brands and
          artists.
        </h1>
        {/* Filter  */}
        <div className="w-full flex justify-between mb-6 sticky top-[70px] bg-white z-[997] py-1 md:py-4">
          <div className="flex flex-grow">
            ...
            <div className="border-t border-b border-r lg:border-r-0 border-[#E5E5E5] flex-grow flex items-center px-4 md:px-10 py-5">
              <p className="font-overpass capitalize">{products.flatMap((item) => item.variants).filter((variant) => variant.item_name.toUpperCase().includes('BAPE')).length} Hasil</p>
            </div>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => variant.item_name.toUpperCase().includes('BAPE'))
