...
import heroLifoWork from "../../../assets/banner/03-LIFEWORK.webp";
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroLifoWork} // Pastikan untuk mengganti dengan gambar hero LIFEWORK
          alt="Hero LIFEWORK"
              ...
              <p className="font-overpass capitalize">
                {
                  products
                    ...
                    .filter((variant) =>
                      variant.item_name.toUpperCase().includes("LIFEWORK")
                    ).length
                }{" "}
                Result
              </p>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesLifework = variant.item_name
                      .toUpperCase()
                      .includes("LIFEWORK");
                    ...
                    return matchesLifework && matchesCategory;
                  })
                  .filter(
                    (variant) =>
