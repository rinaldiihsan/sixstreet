...
import heroSupreme from "../../../assets/banner/SUPREME.webp";
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroSupreme} // Pastikan untuk mengganti dengan gambar hero SUPREME
          alt="Hero SUPREME"
          className="w-full h-full md:h-auto mb-6"
        />
        <h1 className="text-center text-xs font-overpass lg:max-w-7xl  md:block md:text-base">
          Supreme is a streetwear brand founded by James Jebbia in New York
          City. Known for its limited-edition releases, iconic logo, and
          collaborations with popular artists and brands, Supreme has become a
          highly sought-after brand in the streetwear community. The brand's
          products, which often include apparel, accessories, and collectibles,
          are characterized by their distinctive design, exclusivity, and high
          resale value. Supreme has gained a reputation for its underground
          appeal, rebellious attitude, and ability to capture the spirit of
          youth culture
        </h1>
        {/* Filter  */}
              ...
              <p className="font-overpass capitalize">
                {
                  products
                    ...
                    .filter((variant) =>
                      variant.item_name.toUpperCase().includes("SUPREME")
                    ).length
                }{" "}
                Result
              </p>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesSupreme = variant.item_name
                      .toUpperCase()
                      .includes("SUPREME");
                    ...
                    return matchesSupreme && matchesCategory;
                  })
                  .filter(
                    (variant) =>
