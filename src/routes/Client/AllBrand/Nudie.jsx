...
import heroNudieJeans from "../../../assets/banner/NUDIE-JEANS.webp";
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroNudieJeans} // Pastikan untuk mengganti dengan gambar hero NUDIE
          alt="Hero NUDIE"
              ...
              <p className="font-overpass capitalize">
                {
                  products
                    ...
                    .filter((variant) =>
                      variant.item_name.toUpperCase().includes("NUDIE")
                    ).length
                }{" "}
                Result
              </p>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesNudie = variant.item_name
                      .toUpperCase()
                      .includes("NUDIE");
                    ...
                    return matchesNudie && matchesCategory;
                  })
                  .filter(
                    (variant) =>
