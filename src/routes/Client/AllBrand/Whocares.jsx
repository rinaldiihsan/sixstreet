...
import heroWhoCares from "../../../assets/banner/01-WHO-CARES.webp";
      ...
      if (response.status === 200) {
        ...
        const sixstreetProducts = data.filter((item) =>
          item?.variants?.some((variant) => {
            ...
            return name.includes("who cares");
          })
        );
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroWhoCares} // Pastikan untuk mengganti dengan gambar hero WHO CARES
          alt="Hero WHO CARES"
              ...
              <p className="font-overpass capitalize">
                {
                  products
                    ...
                    .filter((variant) =>
                      variant.item_name.toUpperCase().includes("WHO CARES")
                    ).length
                }{" "}
                Result
              </p>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesWhoCares = variant.item_name
                      .toUpperCase()
                      .includes("WHO CARES");
                    ...
                    return matchesWhoCares && matchesCategory;
                  })
                  .filter(
                    (variant) =>
