...
import heroRic from "../../../assets/banner/02-RIC.webp";
      ...
      if (response.status === 200) {
        ...
        const sixstreetProducts = data.filter((item) =>
          item?.variants?.some((variant) => {
            ...
            return name.includes("ricky is clown");
          })
        );
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroRic} // Pastikan untuk mengganti dengan gambar hero RICKY IS CLOWN
              ...
              <p className="font-overpass capitalize">
                {
                  products
                    ...
                    .filter((variant) =>
                      variant.item_name.toUpperCase().includes("RICKY IS CLOWN")
                    ).length
                }{" "}
                Result
              </p>
        ...
        <div className="w-full flex justify-between gap-x-3">
          ...
          {/* Product Grid */}
          <div className="w-full grid grid-cols-2 gap-5 lg:grid-cols-3 mb-10 overflow-y-auto h-[calc(100vh-4rem)] md:px-5 overflow-x-hidden scroll-hidden scroll-hidden scroll-hidden">
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesRickyIsClown = variant.item_name
                      .toUpperCase()
                      .includes("RICKY IS CLOWN");
                    ...
                    return matchesRickyIsClown && matchesCategory;
                  })
                  .filter(
                    (variant) =>
