...
import heroAmiParis from '../../../assets/banner/AMI-PARIS.webp';
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroAmiParis} // Pastikan untuk mengganti dengan gambar hero AMI PARIS
          alt="Hero AMI PARIS"
          className="w-full h-full md:h-auto mb-6"
        />

        <h1 className="text-center text-xs font-overpass lg:max-w-7xl  md:block md:text-base">
          Ami Paris is a French fashion brand founded in 2011 by Alexandre Mattiussi. Known for its Parisian-inspired casual chic style, Ami Paris offers a range of menswear and womenswear collections. The brand is recognized for its clean
          lines, minimalist aesthetic, and signature "Ami" heart logo.
        </h1>
        ...
        <div className="w-full flex justify-between mb-6 sticky top-[70px] bg-white z-[997] py-1 md:py-4">
          <div className="flex flex-grow">
            ...
            <div className="border-t border-b border-r lg:border-r-0 border-[#E5E5E5] flex-grow flex items-center px-4 md:px-10 py-5">
              <p className="font-overpass capitalize">{products.flatMap((item) => item.variants).filter((variant) => variant.item_name.toUpperCase().includes('AMI PARIS')).length} Hasil</p>
            </div>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => variant.item_name.toUpperCase().includes('AMI PARIS'))
