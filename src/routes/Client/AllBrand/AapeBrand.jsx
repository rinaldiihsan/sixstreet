...
import heroAape from '../../../assets/banner/AAPE.webp';
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroAape} // Pastikan untuk mengganti dengan gambar hero AAPE
          alt="Hero AAPE"
          className="w-full h-full md:h-auto mb-6"
        />
        <h1 className="text-center text-xs font-overpass lg:max-w-7xl  md:block md:text-base">
          Aape is a Japanese streetwear brand founded by BAPE, a popular Japanese streetwear label. Aape offers a more affordable and accessible line of clothing and accessories inspired by BAPE's signature style. Known for its playful
          designs, bold graphics, and iconic Baby Milo character, Aape has gained a strong following among streetwear enthusiasts.
        </h1>
        ...
        <div className="w-full flex justify-between mb-6 sticky top-[70px] bg-white z-[997] py-1 md:py-4">
          <div className="flex flex-grow">
            ...
            <div className="border-t border-b border-r lg:border-r-0 border-[#E5E5E5] flex-grow flex items-center px-4 md:px-10 py-5">
              <p className="font-overpass capitalize">{products.flatMap((item) => item.variants).filter((variant) => variant.item_name.toUpperCase().includes('AAPE')).length} Hasil</p>
            </div>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => variant.item_name.toUpperCase().includes('AAPE'))
