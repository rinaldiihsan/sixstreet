...
import heroStussy from "../../../assets/banner/STUSSY.webp";
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroStussy} // Pastikan untuk mengganti dengan gambar hero STUSSY
          alt="Hero STUSSY"
          className="w-full h-full md:h-auto mb-6"
        />
        <h1 className="text-center text-xs font-overpass lg:max-w-7xl  md:block md:text-base">
          Stussy is a streetwear brand founded by Shawn Stussy in California in
          1980. Known for its iconic logo and surf-inspired aesthetic, Stussy
          has become a global streetwear phenomenon. The brand offers a wide
          range of products, including apparel, accessories, and footwear,
          characterized by a blend of classic American style, modern streetwear
          influences, and a rebellious spirit. Stussy is often associated with
          skate culture, surf culture, and a sense of youthfulness.
        </h1>
        {/* Filter  */}
              ...
              <p className="font-overpass capitalize">
                {
                  products
                    ...
                    .filter((variant) =>
                      variant.item_name.toUpperCase().includes("STUSSY")
                    ).length
                }{" "}
                Result
              </p>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesStussy = variant.item_name
                      .toUpperCase()
                      .includes("STUSSY");
                    ...
                    return matchesStussy && matchesCategory;
                  })
                  .filter(
                    (variant) =>
