...
import heroPalmAngels from "../../../assets/banner/PALM-ANGELS.webp";
      ...
      if (response.status === 200) {
        ...
        const sixstreetProducts = data.filter((item) =>
          item?.variants?.some((variant) => {
            ...
            return name.includes("palm angels");
          })
        );
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroPalmAngels} // Pastikan untuk mengganti dengan gambar hero PALM ANGELS
              ...
              <p className="font-overpass capitalize">
                {
                  products
                    ...
                    .filter((variant) =>
                      variant.item_name.toUpperCase().includes("PALM ANGELS")
                    ).length
                }{" "}
                Result
              </p>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesPalmAngels = variant.item_name
                      .toUpperCase()
                      .includes("PALM ANGELS");
                    ...
                    return matchesPalmAngels && matchesCategory;
                  })
                  .filter(
                    (variant) =>
