...
import heroMschf from "../../../assets/banner/MSCHF.webp";
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroMschf} // Pastikan untuk mengganti dengan gambar hero MSCHF
          alt="Hero MSCHF"
              ...
              <p className="font-overpass capitalize">
                {
                  products
                    ...
                    .filter((variant) =>
                      variant.item_name.toUpperCase().includes("MSCHF")
                    ).length
                }{" "}
                Result
              </p>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesMschf = variant.item_name
                      .toUpperCase()
                      .includes("MSCHF");
                    ...
                    return matchesMschf && matchesCategory;
                  })
                  .filter(
                    (variant) =>
