...
import heroLacoste from "../../../assets/banner/lacoste.webp";
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroLacoste} // Pastikan untuk mengganti dengan gambar hero LACOSTE
          alt="Hero LACOSTE"
          className="w-full h-full md:h-auto mb-6"
        />
        <h1 className="text-center text-xs font-overpass lg:max-w-7xl  md:block md:text-base">
          Lacoste is a French fashion brand founded by René Lacoste, the
          legendary tennis player. Known for its iconic crocodile logo and polo
          shirts, Lacoste has become a symbol of timeless elegance and casual
          sophistication. The brand offers a wide range of products, including
          apparel, footwear, and accessories, characterized by a blend of
          classic French style and modern design. Lacoste is often associated
          with tennis, sportsmanship, and a sense of refined casual wear.
        </h1>
        {/* Filter  */}
              ...
              <p className="font-overpass capitalize">
                {
                  products
                    ...
                    .filter((variant) =>
                      variant.item_name.toUpperCase().includes("LACOSTE")
                    ).length
                }{" "}
                Result
              </p>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesLacoste = variant.item_name
                      .toUpperCase()
                      .includes("LACOSTE");
                    ...
                    return matchesLacoste && matchesCategory;
                  })
                  .filter(
                    (variant) =>
