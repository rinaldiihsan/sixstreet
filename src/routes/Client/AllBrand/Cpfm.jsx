      ...
      if (response.status === 200) {
        ...
        const sixstreetProducts = data.filter((item) =>
          item?.variants?.some((variant) => {
            ...
            return name.includes('cactus plant flea market');
          })
        );
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesCactus = variant.item_name.toUpperCase().includes('CACTUS PLANT FLEA MARKET');
                    ...
                    return matchesCactus && matchesCategory;
                  })
