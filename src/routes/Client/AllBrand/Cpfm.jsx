...
import heroCpfm from '../../../assets/banner/CPFM.webp';
const Cpfm = () => {
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroCpfm} // Pastikan untuk mengganti dengan gambar hero CACTUS PLANT FLEA MARKET
          alt="Hero CACTUS PLANT FLEA MARKET"
          className="w-full h-full md:h-auto mb-6"
        />
        <h1 className="text-center text-xs font-overpass lg:max-w-7xl  md:block md:text-base">
          CPFM is a streetwear brand founded by Cynthia Lu in Los Angeles. Known for its playful and irreverent designs, CPFM often incorporates pop culture references, bold graphics, and a sense of humor into its collections. The brand's
          products, which include apparel, accessories, and collectibles, are highly sought after by streetwear enthusiasts and collectors. CPFM has gained a reputation for its limited-edition releases and collaborations with other brands
          and artists.
        </h1>
        {/* Filter  */}
        <div className="w-full flex justify-between mb-6 sticky top-[70px] bg-white z-[997] py-1 md:py-4">
          <div className="flex flex-grow">
            ...
            <div className="border-t border-b border-r lg:border-r-0 border-[#E5E5E5] flex-grow flex items-center px-4 md:px-10 py-5">
              <p className="font-overpass capitalize">{products.flatMap((item) => item.variants).filter((variant) => variant.item_name.toUpperCase().includes('CACTUS PLANT FLEA MARKET')).length} Hasil</p>
            </div>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => variant.item_name.toUpperCase().includes('CACTUS PLANT FLEA MARKET'))
