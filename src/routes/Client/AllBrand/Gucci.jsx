...
import heroGucci from "../../../assets/banner/GUCCI.webp";
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroGucci} // Pastikan untuk mengganti dengan gambar hero GUCCI
          alt="Hero GUCCI"
              ...
              <p className="font-overpass capitalize">
                {
                  products
                    ...
                    .filter((variant) =>
                      variant.item_name.toUpperCase().includes("GUCCI")
                    ).length
                }{" "}
                Result
              </p>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesGucci = variant.item_name
                      .toUpperCase()
                      .includes("GUCCI");
                    ...
                    return matchesGucci && matchesCategory;
                  })
                  .filter(
                    (variant) =>
