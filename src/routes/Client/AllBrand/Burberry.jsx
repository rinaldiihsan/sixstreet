...
import heroBurberry from '../../../assets/banner/burberry.webp';
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroBurberry} // Pastikan untuk mengganti dengan gambar hero BURBERRY
          alt="Hero BURBERRY"
          className="w-full h-full md:h-auto mb-6"
        />
        <h1 className="text-center text-xs font-overpass lg:max-w-7xl  md:block md:text-base">
          Burberry is a British luxury fashion house known for its iconic trench coats and signature plaid pattern. Founded in 1856, Burberry has a long history of creating timeless and elegant clothing. The brand offers a wide range of
          products, including apparel, accessories, and fragrances, characterized by a blend of tradition and modernity. Burberry is associated with British heritage, quality craftsmanship, and a sophisticated aesthetic.
        </h1>
        {/* Filter  */}
        <div className="w-full flex justify-between mb-6 sticky top-[70px] bg-white z-[997] py-1 md:py-4">
          <div className="flex flex-grow">
            ...
            <div className="border-t border-b border-r lg:border-r-0 border-[#E5E5E5] flex-grow flex items-center px-4 md:px-10 py-5">
              <p className="font-overpass capitalize">{products.flatMap((item) => item.variants).filter((variant) => variant.item_name.toUpperCase().includes('BURBERRY')).length} Hasil</p>
            </div>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => variant.item_name.toUpperCase().includes('BURBERRY'))
