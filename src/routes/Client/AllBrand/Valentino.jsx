...
import heroValentino from "../../../assets/banner/VALENTINO.webp";
      ...
      if (response.status === 200) {
        ...
        const sixstreetProducts = data.filter((item) =>
          item?.variants?.some((variant) => {
            ...
            return name.includes("valentino");
          })
        );
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroValentino} // Pastikan untuk mengganti dengan gambar hero VALENTINO GARAVANI
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesValentino = variant.item_name
                      .toUpperCase()
                      .includes("VALENTINO");
                    ...
                    return matchesValentino && matchesCategory;
                  })
                  .filter(
                    (variant) =>
