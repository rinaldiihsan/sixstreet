      ...
      if (response.status === 200) {
        ...
        const sixstreetProducts = data.filter((item) =>
          item?.variants?.some((variant) => {
            ...
            return name.includes('christian louboutin');
          })
        );
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesChristian = variant.item_name.toUpperCase().includes('CHRISTIAN LOUBOUTIN');
                    ...
                    return matchesChristian && matchesCategory;
                  })
