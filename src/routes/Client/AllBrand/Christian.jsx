...
import heroChristianLouboutin from '../../../assets/banner/Christian-louboutin.webp';
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroChristianLouboutin} // Pastikan untuk mengganti dengan gambar hero CHRISTIAN LOUBOUTIN
          alt="Hero CHRISTIAN LOUBOUTIN"
          className="w-full h-full md:h-auto mb-6"
        />
        <h1 className="text-center text-xs font-overpass lg:max-w-7xl  md:block md:text-base">
          Christian Louboutin is a French luxury footwear designer renowned for his signature red-soled high heels. Louboutin's shoes are known for their elegance, femininity, and bold designs. His creations often feature intricate details,
          exotic materials, and statement-making silhouettes. Louboutin has become a symbol of luxury and glamour, and his shoes are highly sought after by celebrities and fashion enthusiasts worldwide.
        </h1>
        {/* Filter  */}
        <div className="w-full flex justify-between mb-6 sticky top-[70px] bg-white z-[997] py-1 md:py-4">
          <div className="flex flex-grow">
            ...
            <div className="border-t border-b border-r lg:border-r-0 border-[#E5E5E5] flex-grow flex items-center px-4 md:px-10 py-5">
              <p className="font-overpass capitalize">{products.flatMap((item) => item.variants).filter((variant) => variant.item_name.toUpperCase().includes('CHRISTIAN LOUBOUTIN')).length} Hasil</p>
            </div>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => variant.item_name.toUpperCase().includes('CHRISTIAN LOUBOUTIN'))
