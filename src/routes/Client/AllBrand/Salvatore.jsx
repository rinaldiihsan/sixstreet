...
import heroSalvatore from "../../../assets/banner/FERRAGAMO.webp";
      ...
      if (response.status === 200) {
        ...
        const sixstreetProducts = data.filter((item) =>
          item?.variants?.some((variant) => {
            ...
            return name.includes("salvatore ferragamo");
          })
        );
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroSalvatore} // Pastikan untuk mengganti dengan gambar hero SALVATORE FERRAGAMO
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesSalvatore = variant.item_name
                      .toUpperCase()
                      .includes("SALVATORE FERRAGAMO");
                    ...
                    return matchesSalvatore && matchesCategory;
                  })
                  .filter((variant) =>
                    variant.item_name
                      .toUpperCase()
