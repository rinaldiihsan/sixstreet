...
import heroFierDeMoi from '../../../assets/banner/FIER-DE-MOI.webp';
const Fierdemoi = () => {
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroFierDeMoi} // Pastikan untuk mengganti dengan gambar hero FIER DE MOI
          alt="Hero FIER DE MOI"
          className="w-full h-full md:h-auto mb-6"
        />
        <h1 className="text-center text-xs font-overpass lg:max-w-7xl  md:block md:text-base">
          Fier de Moi, a new brand from Korea, is blowing up everywhere right now! This brand has caught everyone’s attention with a fresh and unique vibe. 'Fier de Moi' means 'proud of myself' in French, and the brand often features Iris
          flower graphics, symbolizing self-pride and individuality. Wear Fier de Moi and celebrate what makes you uniquely you!
        </h1>
        {/* Filter  */}
        <div className="w-full flex justify-between mb-6 sticky top-[70px] bg-white z-[997] py-1 md:py-4">
          <div className="flex flex-grow">
            ...
            <div className="border-t border-b border-r lg:border-r-0 border-[#E5E5E5] flex-grow flex items-center px-4 md:px-10 py-5">
              <p className="font-overpass capitalize">{products.flatMap((item) => item.variants).filter((variant) => variant.item_name.toUpperCase().includes('FIER DE MOI')).length} Hasil</p>
            </div>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => variant.item_name.toUpperCase().includes('FIER DE MOI'))
