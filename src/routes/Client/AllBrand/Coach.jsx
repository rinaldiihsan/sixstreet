...
import heroCoach from '../../../assets/banner/Coach.webp';
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroCoach} // Pastikan untuk mengganti dengan gambar hero COACH
          alt="Hero COACH"
          className="w-full h-full md:h-auto mb-6"
        />
        <h1 className="text-center text-xs font-overpass lg:max-w-7xl  md:block md:text-base">
          Coach is an American luxury fashion brand known for its leather goods and accessories. Founded in 1941, Coach has a long history of crafting quality handbags, wallets, and other leather items. The brand's designs often feature
          classic American style, timeless elegance, and a focus on craftsmanship. Coach has expanded its offerings to include apparel, footwear, and fragrance, while maintaining its reputation for quality and luxury.
        </h1>
        {/* Filter  */}
        <div className="w-full flex justify-between mb-6 sticky top-[70px] bg-white z-[997] py-1 md:py-4">
          <div className="flex flex-grow">
            ...
            <div className="border-t border-b border-r lg:border-r-0 border-[#E5E5E5] flex-grow flex items-center px-4 md:px-10 py-5">
              <p className="font-overpass capitalize">{products.flatMap((item) => item.variants).filter((variant) => variant.item_name.toUpperCase().includes('COACH')).length} Hasil</p>
            </div>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => variant.item_name.toUpperCase().includes('COACH'))
