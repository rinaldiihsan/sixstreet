...
import heroBalenciaga from '../../../assets/banner/balenciagaa.webp';
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroBalenciaga} // Pastikan untuk mengganti dengan gambar hero BALENCIAGA
          alt="Hero BALENCIAGA"
          className="w-full h-full md:h-auto mb-6"
        />
        <h1 className="text-center text-xs font-overpass lg:max-w-7xl  md:block md:text-base">
          Balenciaga is a luxury fashion house founded by Cristóbal Balenciaga in Spain. Known for its avant-garde and innovative designs, Balenciaga has been a major influence on the fashion industry. The brand offers a wide range of
          products, including clothing, accessories, and footwear, characterized by bold silhouettes, unconventional materials, and a futuristic aesthetic. Balenciaga is often associated with pushing the boundaries of fashion and
        ...
        <div className="w-full flex justify-between mb-6 sticky top-[70px] bg-white z-[997] py-1 md:py-4">
          <div className="flex flex-grow">
            ...
            <div className="border-t border-b border-r lg:border-r-0 border-[#E5E5E5] flex-grow flex items-center px-4 md:px-10 py-5">
              <p className="font-overpass capitalize">{products.flatMap((item) => item.variants).filter((variant) => variant.item_name.toUpperCase().includes('BALENCIAGA')).length} Hasil</p>
            </div>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => variant.item_name.toUpperCase().includes('BALENCIAGA'))
