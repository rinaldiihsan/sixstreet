      ...
      if (response.status === 200) {
        ...
        const sixstreetProducts = data.filter((item) =>
          item?.variants?.some((variant) => {
            ...
            return name.includes("balenciaga");
          })
        );
    ...
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <h1 className="text-center text-xs font-overpass lg:max-w-7xl  md:block md:text-base">
          Balenciaga is a luxury fashion house founded by Cristóbal Balenciaga
          in Spain. Known for its avant-garde and innovative designs, Balenciaga
          has been a major influence on the fashion industry. The brand offers a
          wide range of products, including clothing, accessories, and footwear,
          characterized by bold silhouettes, unconventional materials, and a
          futuristic aesthetic. Balenciaga is often associated with pushing the
          boundaries of fashion and challenging traditional norms.
        </h1>
        {/* Filter  */}
              ...
              <p className="font-overpass capitalize">
                {
                  products
                    ...
                    .filter((variant) =>
                      variant.item_name.toUpperCase().includes("BALENCIAGA")
                    ).length
                }{" "}
                Result
              </p>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesBalenciaga = variant.item_name
                      .toUpperCase()
                      .includes("BALENCIAGA");
                    ...
                    return matchesBalenciaga && matchesCategory;
                  })
                  .filter(
                    (variant) =>
