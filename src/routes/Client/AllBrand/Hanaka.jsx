...
import heroHanaka from "../../../assets/banner/HANAKA.webp";
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroHanaka} // Pastikan untuk mengganti dengan gambar hero HANAKA
          alt="Hero HANAKA"
              ...
              <p className="font-overpass capitalize">
                {
                  products
                    ...
                    .filter((variant) =>
                      variant.item_name.toUpperCase().includes("HANAKA")
                    ).length
                }{" "}
                Result
              </p>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesHanaka = variant.item_name
                      .toUpperCase()
                      .includes("HANAKA");
                    ...
                    return matchesHanaka && matchesCategory;
                  })
                  .filter(
                    (variant) =>
