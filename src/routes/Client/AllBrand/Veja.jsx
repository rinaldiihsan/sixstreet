...
import heroVeja from "../../../assets/banner/veja.webp";
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroVeja} // Pastikan untuk mengganti dengan gambar hero VEJA
          alt="Hero VEJA"
              ...
              <p className="font-overpass capitalize">
                {
                  products
                    ...
                    .filter((variant) =>
                      variant.item_name.toUpperCase().includes("VEJA")
                    ).length
                }{" "}
                Result
              </p>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesVeja = variant.item_name
                      .toUpperCase()
                      .includes("VEJA");
                    ...
                    return matchesVeja && matchesCategory;
                  })
                  .filter(
                    (variant) =>
