      ...
      if (response.status === 200) {
        ...
        const sixstreetProducts = data.filter((item) =>
          item?.variants?.some((variant) => {
            ...
            return name.includes('billionaire');
          })
        );
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesBilionare = variant.item_name.toUpperCase().includes('BILLIONAIRE BOYS CLUB');
                    ...
                    return matchesBilionare && matchesCategory;
                  })
