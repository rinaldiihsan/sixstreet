...
import heroBillionare from '../../../assets/banner/Billionare.webp';
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroBillionare} // Pastikan untuk mengganti dengan gambar hero BILLIONAIRE BOYS CLUB
          alt="Hero BILLIONAIRE BOYS CLUB"
          className="w-full h-full md:h-auto mb-6"
        />
        <h1 className="text-center text-xs font-overpass lg:max-w-7xl  md:block md:text-base">
          Billionaire Boys Club (BBC) is a streetwear brand founded by Pharrell Williams and Nigo. Known for its luxurious and aspirational aesthetic, BBC offers a range of apparel and accessories featuring bold graphics, high-quality
          materials, and a focus on exclusivity. The brand's designs often incorporate elements of pop culture, streetwear, and luxury fashion. BBC has gained a loyal following among celebrities and fashion enthusiasts for its unique style
          and premium quality.
        </h1>
        {/* Filter  */}
        <div className="w-full flex justify-between mb-6 sticky top-[70px] bg-white z-[997] py-1 md:py-4">
          <div className="flex flex-grow">
            ...
            <div className="border-t border-b border-r lg:border-r-0 border-[#E5E5E5] flex-grow flex items-center px-4 md:px-10 py-5">
              <p className="font-overpass capitalize">{products.flatMap((item) => item.variants).filter((variant) => variant.item_name.toUpperCase().includes('BILLIONAIRE BOYS CLUB')).length} Hasil</p>
            </div>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => variant.item_name.toUpperCase().includes('BILLIONAIRE BOYS CLUB'))
