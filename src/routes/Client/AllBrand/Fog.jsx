      ...
      if (response.status === 200) {
        ...
        const sixstreetProducts = data.filter((item) =>
          item?.variants?.some((variant) => {
            ...
            return name.includes("fear of god");
          })
        );
              ...
              <p className="font-overpass capitalize">
                {
                  products
                    ...
                    .filter((variant) =>
                      variant.item_name.toUpperCase().includes("FEAR OF GOD")
                    ).length
                }{" "}
                Result
              </p>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesFearOfGod = variant.item_name
                      .toUpperCase()
                      .includes("FEAR OF GOD");
                    ...
                    return matchesFearOfGod && matchesCategory;
                  })
                  .filter(
                    (variant) =>
