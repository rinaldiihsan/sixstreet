...
import heroFog from '../../../assets/banner/FOG.webp';
const Fog = () => {
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroFog} // Pastikan untuk mengganti dengan gambar hero FEAR OF GOD
          alt="Hero FEAR OF GOD"
          className="w-full h-full md:h-auto mb-6"
        />
        <h1 className="text-center text-xs font-overpass lg:max-w-7xl  md:block md:text-base">
          Fear of God is a luxury streetwear brand founded by Jerry Lorenzo. Known for its elevated and spiritual aesthetic, Fear of God offers a range of menswear and womenswear collections characterized by oversized silhouettes, luxurious
          fabrics, and a focus on quality craftsmanship. The brand's designs often incorporate religious imagery, minimalist details, and a sense of elevated streetwear. Fear of God has gained a reputation for its innovative approach to
          fashion and its ability to blend streetwear elements with a more refined and sophisticated aesthetic.
        </h1>
        {/* Filter  */}
        <div className="w-full flex justify-between mb-6 sticky top-[70px] bg-white z-[997] py-1 md:py-4">
          <div className="flex flex-grow">
            ...
            <div className="border-t border-b border-r lg:border-r-0 border-[#E5E5E5] flex-grow flex items-center px-4 md:px-10 py-5">
              <p className="font-overpass capitalize">{products.flatMap((item) => item.variants).filter((variant) => variant.item_name.toUpperCase().includes('FEAR OF GOD')).length} Hasil</p>
            </div>
            ...
            <div className="mb-6">
              ...
              <ul className="mt-3 space-y-2">
                <li className="flex items-center gap-x-2">
                  <input type="checkbox" className="border border-[#E5E5E5] focus:outline-none focus:shadow-outline focus:border-[#E5E5E5] focus:ring-0" name="brand" id="JORDAN" value="JORDAN" onChange={handleBrandChange} />
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => variant.item_name.toUpperCase().includes('FEAR OF GOD'))
