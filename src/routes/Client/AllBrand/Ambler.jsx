...
import heroAmbler from '../../../assets/banner/AMBLER.webp';
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroAmbler} // Pastikan untuk mengganti dengan gambar hero AMBLER
          alt="Hero AMBLER"
          className="w-full h-full md:h-auto mb-6"
        />
        <h1 className="text-center text-xs font-overpass lg:max-w-7xl  md:block md:text-base">
          AMBLER is a streetwear brand from South Korea, brings fresh options to your wardrobe with its signature ‘cute animal’ prints and appliqués. Dive into their collection of boxy T-shirts, oversized outerwear, and versatile bottoms,
          all in earthy tones like Midnight Navy, Khaki, and Misty Grey. Inspired by nature and ethnic clothing, AMBLER adds a unique, playful touch to every outfit.
        </h1>
        ...
        <div className="w-full flex justify-between mb-6 sticky top-[70px] bg-white z-[997] py-1 md:py-4">
          <div className="flex flex-grow">
            ...
            <div className="border-t border-b border-r lg:border-r-0 border-[#E5E5E5] flex-grow flex items-center px-4 md:px-10 py-5">
              <p className="font-overpass capitalize">{products.flatMap((item) => item.variants).filter((variant) => variant.item_name.toUpperCase().includes('AMBLER')).length} Hasil</p>
            </div>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => variant.item_name.toUpperCase().includes('AMBLER'))
