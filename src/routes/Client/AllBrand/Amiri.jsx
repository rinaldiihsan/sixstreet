...
import heroAmiriFin from '../../../assets/banner/Amiri-fin.webp';
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroAmiriFin} // Pastikan untuk mengganti dengan gambar hero AMIRI
          alt="Hero AMIRI"
          className="w-full h-full md:h-auto mb-6"
        />
        <h1 className="text-center text-xs font-overpass lg:max-w-7xl  md:block md:text-base">
          Amiri is a luxury streetwear brand founded by Mike Amiri in Los Angeles. Known for its rock and roll-inspired aesthetic, Amiri offers a range of menswear and womenswear collections, including denim, leather jackets, and graphic
          tees. The brand is recognized for its high-quality materials, distressed detailing, and rebellious attitude. Amiri has gained a following among celebrities and fashion enthusiasts for its edgy yet sophisticated style.
        </h1>
        ...
        <div className="w-full flex justify-between mb-6 sticky top-[70px] bg-white z-[997] py-1 md:py-4">
          <div className="flex flex-grow">
            ...
            <div className="border-t border-b border-r lg:border-r-0 border-[#E5E5E5] flex-grow flex items-center px-4 md:px-10 py-5">
              <p className="font-overpass capitalize">{products.flatMap((item) => item.variants).filter((variant) => variant.item_name.toUpperCase().includes('AMIRI')).length} Hasil</p>
            </div>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => variant.item_name.toUpperCase().includes('AMIRI'))
