...
import heroAlexander from '../../../assets/banner/Alexander-McQueen.webp';
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroAlexander} // Pastikan untuk mengganti dengan gambar hero ALEXANDER MCQUEEN
          alt="Hero ALEXANDER MCQUEEN"
          className="w-full h-full md:h-auto mb-6"
        />
        <h1 className="text-center text-xs font-overpass lg:max-w-7xl  md:block md:text-base">
          Alexander McQueen is a British luxury fashion house founded by the renowned designer Alexander McQueen. Known for its dramatic and theatrical designs, McQueen's collections often push the boundaries of fashion with innovative
          silhouettes, intricate details, and bold aesthetics. The brand is associated with high-quality craftsmanship, avant-garde style, and a strong sense of individuality.
        </h1>
        ...
        <div className="w-full flex justify-between mb-6 sticky top-[70px] bg-white z-[997] py-1 md:py-4">
          <div className="flex flex-grow">
            ...
            <div className="border-t border-b border-r lg:border-r-0 border-[#E5E5E5] flex-grow flex items-center px-4 md:px-10 py-5">
              <p className="font-overpass capitalize">{products.flatMap((item) => item.variants).filter((variant) => variant.item_name.toUpperCase().includes('ALEXANDER MCQUEEN')).length} Hasil</p>
            </div>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => variant.item_name.toUpperCase().includes('ALEXANDER MCQUEEN'))
