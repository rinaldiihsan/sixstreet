      ...
      if (response.status === 200) {
        ...
        const sixstreetProducts = data.filter((item) =>
          item?.variants?.some((variant) => {
            ...
            return name.includes('alexander mcqueen');
          })
        );
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesAlexanderMcqueen = variant.item_name.toUpperCase().includes('ALEXANDER MCQUEEN');
                    ...
                    return matchesAlexanderMcqueen && matchesCategory;
                  })
