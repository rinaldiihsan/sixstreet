...
import heroKith from "../../../assets/banner/KITH.webp";
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroKith} // Pastikan untuk mengganti dengan gambar hero KITH
          alt="Hero KITH"
              ...
              <p className="font-overpass capitalize">
                {
                  products
                    ...
                    .filter((variant) =>
                      variant.item_name.toUpperCase().includes("KITH")
                    ).length
                }{" "}
                Result
              </p>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesKith = variant.item_name
                      .toUpperCase()
                      .includes("KITH");
                    ...
                    return matchesKith && matchesCategory;
                  })
                  .filter(
                    (variant) =>
