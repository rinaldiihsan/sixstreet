...
import heroBatterGoods from '../../../assets/banner/BETTER-GOODS.webp';
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroBatterGoods} // Pastikan untuk mengganti dengan gambar hero BETTER GOODS
          alt="Hero BETTER GOODS"
          className="w-full h-full md:h-auto mb-6"
        />
        <h1 className="text-center text-xs font-overpass lg:max-w-7xl  md:block md:text-base">
          Better Goods is a brand rooted in the new age of minimalist philosophy, focusing on quality and honest choices in their garments. Embracing slow-paced living, Better Goods challenges conventional views on comfort and style,
          proving that sometimes, less truly is more. This brand fits your style if you're all about refined simplicity and authentic comfort.
        </h1>
        {/* Filter  */}
        <div className="w-full flex justify-between mb-6 sticky top-[70px] bg-white z-[997] py-1 md:py-4">
          <div className="flex flex-grow">
            ...
            <div className="border-t border-b border-r lg:border-r-0 border-[#E5E5E5] flex-grow flex items-center px-4 md:px-10 py-5">
              <p className="font-overpass capitalize">{products.flatMap((item) => item.variants).filter((variant) => variant.item_name.toUpperCase().includes('BETTER GOODS')).length} Hasil</p>
            </div>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => variant.item_name.toUpperCase().includes('BETTER GOODS'))
