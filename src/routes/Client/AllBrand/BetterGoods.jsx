      ...
      if (response.status === 200) {
        ...
        const sixstreetProducts = data.filter((item) =>
          item?.variants?.some((variant) => {
            ...
            return name.includes('better goods');
          })
        );
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesBattergoods = variant.item_name.toUpperCase().includes('BETTER GOODS');
                    ...
                    return matchesBattergoods && matchesCategory;
                  })
