...
import heroOffWhite from "../../../assets/banner/OFF-WHITE.webp";
      ...
      if (response.status === 200) {
        ...
        const sixstreetProducts = data.filter((item) =>
          item?.variants?.some((variant) => {
            ...
            return name.includes("off white");
          })
        );
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroOffWhite} // Pastikan untuk mengganti dengan gambar hero OFF WHITE
          alt="Hero OFF WHITE"
              ...
              <p className="font-overpass capitalize">
                {
                  products
                    ...
                    .filter((variant) =>
                      variant.item_name.toUpperCase().includes("OFF WHITE")
                    ).length
                }{" "}
                Result
              </p>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesOffWhite = variant.item_name
                      .toUpperCase()
                      .includes("OFF WHITE");
                    ...
                    return matchesOffWhite && matchesCategory;
                  })
                  .filter(
                    (variant) =>
