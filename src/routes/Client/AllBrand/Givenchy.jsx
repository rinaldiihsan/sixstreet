...
import heroGivenchy from "../../../assets/banner/GIVENCHY.webp";
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroGivenchy} // Pastikan untuk mengganti dengan gambar hero GIVENCHY
          alt="Hero GIVENCHY"
              ...
              <p className="font-overpass capitalize">
                {
                  products
                    ...
                    .filter((variant) =>
                      variant.item_name.toUpperCase().includes("GIVENCHY")
                    ).length
                }{" "}
                Result
              </p>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesGivenchy = variant.item_name
                      .toUpperCase()
                      .includes("GIVENCHY");
                    ...
                    return matchesGivenchy && matchesCategory;
                  })
                  .filter(
                    (variant) =>
