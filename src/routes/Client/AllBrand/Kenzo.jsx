...
import heroKenzo from "../../../assets/banner/KENZO.webp";
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroKenzo} // Pastikan untuk mengganti dengan gambar hero KENZO
          alt="Hero KENZO"
              ...
              <p className="font-overpass capitalize">
                {
                  products
                    ...
                    .filter((variant) =>
                      variant.item_name.toUpperCase().includes("KENZO")
                    ).length
                }{" "}
                Result
              </p>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesKenzo = variant.item_name
                      .toUpperCase()
                      .includes("KENZO");
                    ...
                    return matchesKenzo && matchesCategory;
                  })
                  .filter(
                    (variant) =>
