...
import heroHugo from "../../../assets/banner/HHUGO.webp";
      ...
      if (response.status === 200) {
        ...
        const sixstreetProducts = data.filter((item) =>
          item?.variants?.some((variant) => {
            ...
            return name.includes("hugo boss");
          })
        );
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroHugo} // Pastikan untuk mengganti dengan gambar hero HUGO BOSS
          alt="Hero HUGO BOSS"
              ...
              <p className="font-overpass capitalize">
                {
                  products
                    ...
                    .filter((variant) =>
                      variant.item_name.toUpperCase().includes("HUGO BOSS")
                    ).length
                }{" "}
                Result
              </p>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesHugoBoss = variant.item_name
                      .toUpperCase()
                      .includes("HUGO BOSS");
                    ...
                    return matchesHugoBoss && matchesCategory;
                  })
                  .filter(
                    (variant) =>
