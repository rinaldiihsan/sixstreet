...
import heroAmbush from '../../../assets/banner/AMBUSH-FIN.webp';
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroAmbush} // Pastikan untuk mengganti dengan gambar hero AMBUSH
          alt="Hero AMBUSH"
          className="w-full h-full md:h-auto mb-6"
        />
        <h1 className="text-center text-xs font-overpass lg:max-w-7xl  md:block md:text-base">
          Ambush is a Japanese fashion brand founded by Yoon Ahn and Verbal. Known for its edgy and experimental designs, Ambush blends streetwear and high fashion elements. The brand offers a range of jewelry, accessories, and apparel,
          often featuring bold silhouettes, unique materials, and unexpected collaborations. Ambush has gained a reputation for its innovative approach to design and its ability to capture the spirit of contemporary urban culture.
        </h1>
        ...
        <div className="w-full flex justify-between mb-6 sticky top-[70px] bg-white z-[997] py-1 md:py-4">
          <div className="flex flex-grow">
            ...
            <div className="border-t border-b border-r lg:border-r-0 border-[#E5E5E5] flex-grow flex items-center px-4 md:px-10 py-5">
              <p className="font-overpass capitalize">{products.flatMap((item) => item.variants).filter((variant) => variant.item_name.toUpperCase().includes('AMBUSH')).length} Hasil</p>
            </div>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => variant.item_name.toUpperCase().includes('AMBUSH'))
