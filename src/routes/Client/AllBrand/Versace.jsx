...
import heroVersace from "../../../assets/banner/versace-fin.webp";
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroVersace} // Pastikan untuk mengganti dengan gambar hero VERSACE
          alt="Hero VERSACE"
              ...
              <p className="font-overpass capitalize">
                {
                  products
                    ...
                    .filter((variant) =>
                      variant.item_name.toUpperCase().includes("VERSACE")
                    ).length
                }{" "}
                Result
              </p>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesVersace = variant.item_name
                      .toUpperCase()
                      .includes("VERSACE");
                    ...
                    return matchesVersace && matchesCategory;
                  })
                  .filter(
                    (variant) =>
