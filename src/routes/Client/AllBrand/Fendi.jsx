...
import heroFendi from '../../../assets/banner/FENDI.webp';
const Fendi = () => {
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroFendi} // Pastikan untuk mengganti dengan gambar hero FENDI
          alt="Hero FENDI"
          className="w-full h-full md:h-auto mb-6"
        />
        <h1 className="text-center text-xs font-overpass lg:max-w-7xl  md:block md:text-base">
          Fendi is a luxury Italian fashion house founded by Adele and Edoardo Fendi in 1925. Known for its fur and leather goods, Fendi has become a global symbol of luxury and sophistication. The brand's designs are often characterized by
          bold colors, playful patterns, and a focus on craftsmanship. Fendi's iconic Baguette bag has become a fashion statement, and the brand continues to innovate with its collections, pushing the boundaries of luxury and style.
        </h1>
        {/* Filter  */}
        <div className="w-full flex justify-between mb-6 sticky top-[70px] bg-white z-[997] py-1 md:py-4">
          <div className="flex flex-grow">
            ...
            <div className="border-t border-b border-r lg:border-r-0 border-[#E5E5E5] flex-grow flex items-center px-4 md:px-10 py-5">
              <p className="font-overpass capitalize">{products.flatMap((item) => item.variants).filter((variant) => variant.item_name.toUpperCase().includes('FENDI')).length} Hasil</p>
            </div>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => variant.item_name.toUpperCase().includes('FENDI'))
