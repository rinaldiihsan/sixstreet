...
import heroMaritheGirbaud from "../../../assets/banner/04-MARITHE.webp";
import SidebarFilterBrand from "../../../components/SidebarFilterBrand";

const Marithegirbaud = () => {
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroMaritheGirbaud} // Pastikan untuk mengganti dengan gambar hero MARITHE
          alt="Hero MARITHE"
          className="w-full h-full md:h-auto mb-6"
        />
        <h1 className="text-center text-xs font-overpass lg:max-w-7xl  md:block md:text-base">
          Marithe + François Girbaud is a French fashion brand known for its
          innovative designs and denim expertise. The brand was founded by
          Marithe François Girbaud in the 1970s and is known for its unique
          denim treatments, distressed effects, and experimental silhouettes.
          Marithe + François Girbaud has been a pioneer in the denim industry,
          pushing the boundaries of design and introducing new trends. The
          brand's collections often feature a mix of vintage inspiration,
          contemporary style, and a rebellious spirit.
        </h1>
        {/* Filter  */}
              ...
              <p className="font-overpass capitalize">
                {
                  products
                    ...
                    .filter((variant) =>
                      variant.item_name.toUpperCase().includes("MARITHE")
                    ).length
                }{" "}
                Result
              </p>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesMarithe = variant.item_name
                      .toUpperCase()
                      .includes("MARITHE");
                    ...
                    return matchesMarithe && matchesCategory;
                  })
                  .filter(
                    (variant) =>
