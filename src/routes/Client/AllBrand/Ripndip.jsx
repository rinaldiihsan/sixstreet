...
import heroRipnDip from "../../../assets/banner/RIPNDIP-FIN.webp";
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroRipnDip} // Pastikan untuk mengganti dengan gambar hero RIPNDIP
          alt="Hero RIPNDIP"
              ...
              <p className="font-overpass capitalize">
                {
                  products
                    ...
                    .filter((variant) =>
                      variant.item_name.toUpperCase().includes("RIPNDIP")
                    ).length
                }{" "}
                Result
              </p>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesRipNDip = variant.item_name
                      .toUpperCase()
                      .includes("RIPNDIP");
                    ...
                    return matchesRipNDip && matchesCategory;
                  })
                  .filter(
                    (variant) =>
