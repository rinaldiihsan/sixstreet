...
import heroDrMartens from '../../../assets/banner/DR-martens.webp';
const DrMartens = () => {
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroDrMartens} // Pastikan untuk mengganti dengan gambar hero DR MARTENS
          alt="Hero DR MARTENS"
          className="w-full h-full md:h-auto mb-6"
        />
        <h1 className="text-center text-xs font-overpass lg:max-w-7xl  md:block md:text-base">
          Dr. Martens is a British footwear company known for its iconic Doc Martens boots. The brand was founded in 1960 and is famous for its durable, comfortable, and distinctive boots made with Goodyear welted construction. Dr. Martens
          boots have become a cultural icon, associated with punk rock, grunge, and alternative fashion. They are popular among musicians, artists, and individuals who value style, durability, and comfort.
        </h1>
        {/* Filter  */}
        <div className="w-full flex justify-between mb-6 sticky top-[70px] bg-white z-[997] py-1 md:py-4">
          <div className="flex flex-grow">
            ...
            <div className="border-t border-b border-r lg:border-r-0 border-[#E5E5E5] flex-grow flex items-center px-4 md:px-10 py-5">
              <p className="font-overpass capitalize">{products.flatMap((item) => item.variants).filter((variant) => variant.item_name.toUpperCase().includes('DR MARTENS')).length} Hasil</p>
            </div>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => variant.item_name.toUpperCase().includes('DR MARTENS'))
