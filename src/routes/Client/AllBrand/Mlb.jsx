...
import heroMlb from "../../../assets/banner/05-MLB.webp";
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroMlb} // Pastikan untuk mengganti dengan gambar hero MLB
          alt="Hero MLB"
              ...
              <p className="font-overpass capitalize">
                {
                  products
                    ...
                    .filter((variant) =>
                      variant.item_name.toUpperCase().includes("MLB")
                    ).length
                }{" "}
                Result
              </p>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesMlb = variant.item_name
                      .toUpperCase()
                      .includes("MLB");
                    ...
                    return matchesMlb && matchesCategory;
                  })
                  .filter(
                    (variant) =>
