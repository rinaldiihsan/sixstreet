...
import heroVlone from "../../../assets/banner/VLONE.webp";
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroVlone} // Pastikan untuk mengganti dengan gambar hero VLONE
          alt="Hero VLONE"
              ...
              <p className="font-overpass capitalize">
                {
                  products
                    ...
                    .filter((variant) =>
                      variant.item_name.toUpperCase().includes("VLONE")
                    ).length
                }{" "}
                Result
              </p>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesVlone = variant.item_name
                      .toUpperCase()
                      .includes("VLONE");
                    ...
                    return matchesVlone && matchesCategory;
                  })
                  .filter(
                    (variant) =>
