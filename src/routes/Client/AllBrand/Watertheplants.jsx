...
import heroWTP from "../../../assets/banner/WTP.webp";
      ...
      if (response.status === 200) {
        ...
        const sixstreetProducts = data.filter((item) =>
          item?.variants?.some((variant) => {
            ...
            return name.includes("water the plant");
          })
        );
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={heroWTP} // Pastikan untuk mengganti dengan gambar hero WATER THE PLANT
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => {
                    const name = variant.item_name.toLowerCase();
                    const matchesWaterThePlant = variant.item_name
                      .toUpperCase()
                      .includes("WATER THE PLANT");
                    ...
                    return matchesWaterThePlant && matchesCategory;
                  })
                  .filter(
                    (variant) =>
