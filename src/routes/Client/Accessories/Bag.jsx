...
const Bag = () => {
  ...
  // Category IDs for bag products
  const bagCategoryIds = [10217, 36, 5516, 10230, 12622, 12628, 12632, 15320, 18225, 2835, 10222, 12621, 12626, 12631];
  ...
  const getBagProducts = (products) => {
    ...
    const groupedProducts = products.reduce((acc, product) => {
      ...
      if (!bagCategoryIds.includes(product.category_id)) {
        return acc;
      }
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center">
        ...
        <img src={assetBannerBag} alt="Hero Bag" className="w-full h-auto mb-6" />
