  ...
  const fetchProducts = async (token) => {
    try {
      ...
      if (response.status === 200) {
        ...
        const sixstreetProducts = data.filter((item) => [10217, 36, 5516, 10230, 12622, 12628, 12632, 15320, 18225, 2835, 10222, 12621, 12626, 12631].includes(item.item_category_id));
