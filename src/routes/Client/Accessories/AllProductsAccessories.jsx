    ...
    try {
      ...
      if (response.status === 200) {
        ...
        const sixstreetProducts = data.filter((item) =>
          [
            7339, 7340, 17860, 1147, 7332, 1143, 10217, 36, 5516, 10230, 12622,
            12628, 12632, 15320, 18225, 2835, 10222, 12621, 12626, 12631, 24806,
            24807, 1149, 12610, 12611, 10219, 17866, 1139, 1137, 12432, 5429,
              ...
              <p className="font-overpass capitalize">
                {
                  products
                    .filter((item) =>
                      [
                        7339, 7340, 17860, 1147, 7332, 1143, 10217, 36, 5516,
                        10230, 12622, 12628, 12632, 15320, 18225, 2835, 10222,
                        12621, 12626, 12631, 24806, 24807, 1149, 12610, 12611,
                        10219, 17866, 1139, 1137, 12432, 5429,
                      ].includes(item.item_category_id)
                    )
        ...
        <div className="w-full flex justify-between md:gap-x-3 overflow-x-hidden">
          ...
          <div className="w-full grid grid-cols-2 gap-5 lg:grid-cols-3 mb-10 overflow-y-auto h-[calc(100vh-4rem)] md:px-5 overflow-x-hidden scroll-hidden">
            {isLoading ? (
              ...
              products.some((item) =>
                [
                  7339, 7340, 17860, 1147, 7332, 1143, 10217, 36, 5516, 10230,
                  12622, 12628, 12632, 15320, 18225, 2835, 10222, 12621, 12626,
                  12631, 24806, 24807, 1149, 12610, 12611, 10219, 17866, 1139,
                  1137, 12432, 5429,
                ].includes(item.item_category_id)
              ) ? (
              <>
