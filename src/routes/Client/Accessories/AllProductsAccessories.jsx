    ...
    try {
      ...
      if (response.status === 200) {
        ...
        const sixstreetProducts = data.filter((item) =>
          [7339, 7340, 17860, 1147, 7332, 1143, 10217, 36, 5516, 10230, 12622, 12628, 12632, 15320, 18225, 2835, 10222, 12621, 12626, 12631, 24806, 24807, 1149, 12610, 12611, 10219, 17866, 1139, 1137, 12432, 5429].includes(
            ...
            {isLoading ? (
              ...
              <>
                ...
                {Object.values(
                  ...
                  .filter((variant) => !['SIX6STREET PAPER BAG', 'SIXSTREET RING BOX WOOD BLUE', 'PLASTICBAG SIXSTREET.CO.ID'].includes(variant.item_name.trim().toUpperCase()))
