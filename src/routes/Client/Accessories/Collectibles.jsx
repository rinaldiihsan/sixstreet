...
const Collectibles = () => {
  ...
  const collectiblesCategoryIds = [5429];
  ...
  const getBagProducts = (products) => {
    ...
    const groupedProducts = products.reduce((acc, product) => {
      ...
      if (!collectiblesCategoryIds.includes(product.category_id)) {
        return acc;
      }
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center">
        ...
        <img src={assetBannerCollectibles} alt="Hero Bag" className="w-full h-auto mb-6" />
