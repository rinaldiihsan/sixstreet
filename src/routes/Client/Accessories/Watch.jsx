  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img
          src={assetBannerCollectibles}
          alt="Hero collectibles"
          ...
          <div className="w-full grid grid-cols-2 gap-5 lg:grid-cols-3 mb-10 overflow-y-auto h-[calc(100vh-4rem)] md:px-5 overflow-x-hidden">
            {isLoading ? (
              Array.from({ length: 9 }).map((_, index) => (
                <div
                  key={index}
                  className="flex flex-col items-center space-x-32 space-y-5"
                >
              ...
              products.some((item) =>
                [5429].includes(item.item_category_id)
              ) ? (
              <>
                ...
                {Object.values(
                  ...
                  .sort((a, b) => {
                    ...
                    if (selectedOption === "Harga Terendah")
                      return a.sell_price - b.sell_price;
                    if (selectedOption === "Alphabet")
                      return a.item_name.localeCompare(b.item_name);
                    if (selectedOption === "Product Terbaru")
                      return (
                      ...
                      <Link to={`/product-detail/${variant.item_group_id}`}>
                        {variant.parentThumbnail ? (
                          <img
                            ...
                            className="aspect-square w-[10rem] mobileS:w-[10.5rem] mobile:w-[11.5rem] md:w-[23rem] lg:w-[31rem] laptopL:w-[27rem] object-cover"
                          />
                        ) : (
                          <img
                      ...
                      >
                        {variant.parentThumbnail ? (
                          <img
                            src={variant.parentThumbnail}
                            alt={variant.item_name}
                            className="aspect-square w-[10rem] mobileS:w-[10.5rem] mobile:w-[11.5rem] md:w-[23rem] lg:w-[31rem] laptopL:w-[27rem] object-cover opacity-50"
                          />
                        ) : (
                          <img
                            src="/dummy-product.png"
