...
const AllProductsBottoms = () => {
  ...
  const bottomCategoryIds = [7293, 18211, 18212, 911, 27114, 27115, 18205, 18201, 18204];
  ...
  const fetchProducts = async () => {
    try {
      ...
      if (response.data.success) {
        const bottomProducts = getAllProductBottoms(response.data.data);
        setProducts(bottomProducts);
      } else {
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img src={AssetBannerBottoms} alt="Hero T-Shirt" className="w-full h-full md:h-auto mb-6" />
