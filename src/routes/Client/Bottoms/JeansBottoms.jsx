...
const JeansBottoms = () => {
  ...
  const jeansBottomCategoryIds = [7293, 18211, 18212, 911];
  ...
  const fetchProducts = async () => {
    try {
      ...
      if (response.data.success) {
        const jeansProducts = getAllProductJeans(response.data.data);
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img src={assetBannerJeans} alt="Hero T-Shirt" className="w-full h-full md:h-auto mb-6" />
