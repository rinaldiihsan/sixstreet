...
import assetBannerTrouser from '../../../assets/banner/Trouser.webp';
...
const TrouserBottom = () => {
  ...
  const trouserCategoryIds = [18201, 18204];
  ...
  const fetchProducts = async () => {
    try {
      ...
      if (response.data.success) {
        const trouserProducts = getTrouserProducts(response.data.data);
  ...
  return (
    <>
      <div className="mt-20 max-w-[115rem] py-5 mx-auto px-5 md:px-2 flex flex-col justify-center items-center overflow-x-hidden">
        ...
        <img src={assetBannerTrouser} alt="Hero T-Shirt" className="w-full h-full md:h-auto mb-6" />
