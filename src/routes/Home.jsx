      ...
      <main className="overflow-x-hidden">
        ...
        <div className="relative mb-10">
          ...
          <div className="absolute bottom-[5%] md:bottom-[10%] left-1/2 md:left-0 transform -translate-x-1/2 md:translate-x-0 text-white px-5 md:px-10 flex flex-col justify-center items-center md:items-start w-full md:w-auto">
            <div className="md:max-w-[55rem] mb-2 text-center md:text-left w-full max-w-xs ">
              <h1 className="uppercase font-overpass tracking-[5px] md:tracking-[10px] font-extrabold text-xl md:text-3xl">apparel</h1>
              <p className="capitalize font-garamond font-medium text-lg md:text-xl text-center md:text-left lg:text-justify">Elevate your wardrobe with our latest arrivals.</p>
            </div>
