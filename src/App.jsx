      ...
      return (
        <>
          ...
          <Routes>
            ...
            <Route
              path="/user-management/tambah-data-user"
              element={<TambahDataUser />}
            />
            <Route path="/news-management" element={<NewsManagement />} />
            <Route
              path="/news-management/:judulberita"
              element={<NewsManagementDetail />}
            />
            <Route
              path="/news-management/tambah-news"
              element={<TambahNews />}
            />
            <Route
        ...
        <CartProvider>
          ...
          <Routes>
            ...
            <Route
              ...
              element={<Marceloburlon />}
            />
            <Route
              path="/allbrand/marithe-girbaud"
              element={<Marithegirbaud />}
            />
            ...
            <Route
              path="/sale/accessories-sale"
              element={<AccessoriesSale />}
            />
            ...
            <Route
              ...
              element={
                <ProductDetail userId={userId} isLoggedIn={isLoggedIn} />
              }
            />

            {/* Product Detail Sold */}
            <Route
              path="/product-detail-sold/:itemId"
              element={
                <ProductDetailSold userId={userId} isLoggedIn={isLoggedIn} />
              }
            />

            {/* Order */}
            <Route
              path="/checkout/:user_id/:transaction_uuid"
              element={<Checkout isLoggedIn={isLoggedIn} />}
            />
            <Route path="/thank-you" element={<FinishTransaction />} />
            <Route
              path="/order-detail/:user_id/:transaction_uuid"
              element={<OrderDetail isLoggedIn={isLoggedIn} />}
            />
